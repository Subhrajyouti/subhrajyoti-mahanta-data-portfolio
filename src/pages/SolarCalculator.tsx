...
const SolarCalculator: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Start phase animation in parallel
      const phaseAnimation = (async () => {
        for (let i = 0; i < phases.length; i++) {
          setPhaseIndex(i);
          await new Promise(res => setTimeout(res, 2000)); // 2 seconds each phase
        }
      })();

      // Wait for both API call and phase animation to complete
      const [res] = await Promise.all([apiCall, phaseAnimation]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      ...
      <div className="container mx-auto px-3 py-4">
        ...
        <div className="text-center mb-6">
          <div className="flex justify-center items-center mb-1">
            <img 
              ...
              className="h-10 md:h-12 w-auto mx-auto mb-1"
            />
          </div>
        ...
        {/* Main Content */}
        <div className="grid lg:grid-cols-2 gap-8 max-w-3xl mx-auto px-2">

          {/* Left Side - Form (hide when results are shown) */}
          {!result && (
            <div className="space-y-4 max-w-xs ml-1 lg:ml-4">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <Select value={formData.state} onValueChange={v=>handleChange('state',v)}>
                        <SelectTrigger className="h-8 bg-white/50 dark:bg-white/10 backdrop-blur border-white/30 text-sm">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input 
                        ...
                        className="h-8 bg-white/50 dark:bg-white/10 backdrop-blur border-white/30 text-sm"
                      />
                    ...
                    <Button 
                      type="submit" 
                      className="w-full h-8 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm" 
                      disabled={loading}
                    >
                      {loading ? (
                        <>
                  ...
                  <CardContent className="relative z-10 p-3 text-white">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 bg-white/20 backdrop-blur rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Sparkles className="h-3 w-3 text-white" />
                        </div>
                        <div>
                          <h3 className="text-sm font-bold mb-1">Transform Your Home</h3>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-emerald-400 to-teal-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      ...
                      <div className="text-lg font-bold mb-1">15-20%</div>
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-blue-500 to-indigo-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      ...
                      <div className="text-lg font-bold mb-1">4-6 Yrs</div>
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-purple-500 to-pink-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      ...
                      <div className="text-lg font-bold mb-1">10-15%</div>
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-green-500 to-lime-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      ...
                      <div className="text-lg font-bold mb-1">5T+ CO₂</div>
              ...
              <Card className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-xl animate-fade-in hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-blue-500/20 transition-all duration-300" style={{animation: 'floating 40s ease-in-out infinite'}}>
                <CardContent className="p-4">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Analyzing Your Solar Potential</h3>
        ...
        {!loading && result && (
          <div className="space-y-4 animate-fade-in max-w-4xl mx-auto">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white text-center">Your Solar Analysis</h2>
            
            <div className="grid md:grid-cols-3 gap-4">
              {/* Solar Output Card - Now with full grey background like others */}
