  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      ...
      <div className="container mx-auto px-3 py-4">
        ...
        <div className="text-center mb-3">
          <div className="flex justify-center items-center mb-1">
            <img 
              ...
              className="h-10 md:h-12 w-auto mx-auto mb-0"
            />
          </div>
        ...
        {/* Main Content */}
        <div className="grid lg:grid-cols-2 gap-6 max-w-4xl mx-auto px-1 items-start">

          {/* Left Side - Form (hide when results are shown) */}
          {!result && (
            <div className="space-y-3 max-w-sm ml-2 lg:ml-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <Select value={formData.state} onValueChange={v=>handleChange('state',v)}>
                        <SelectTrigger className="h-8 bg-white/50 dark:bg-white/10 backdrop-blur border-white/30 text-xs">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input 
                        ...
                        className="h-8 bg-white/50 dark:bg-white/10 backdrop-blur border-white/30 text-xs"
                      />
                    ...
                    <Button 
                      type="submit" 
                      className="w-full h-8 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-xs" 
                      disabled={loading}
                    >
                      {loading ? (
                        <>
              ...
              <div className="space-y-2">
                  ...
                  <CardContent className="relative z-10 p-3 text-white">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-white/20 backdrop-blur rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Sparkles className="h-4 w-4 text-white" />
                        </div>
                        <div>
                          <h3 className="text-sm font-bold mb-0">Transform Your Home</h3>
                          <p className="text-white/90 text-xs">Into a Clean Energy Powerhouse</p>
                        </div>
                      </div>
                      <ArrowUpRight className="h-3 w-3 text-white/70 group-hover:text-white group-hover:scale-110 transition-all duration-300" />
                    </div>
                    <div className="bg-white/10 backdrop-blur rounded-lg p-2 mb-1">
                      <div className="text-sm font-bold">Free Electricity Forever</div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-emerald-400 to-teal-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      <div className="flex items-center gap-1 mb-1">
                        <TrendingUp className="h-3 w-3 group-hover:scale-110 transition-transform duration-300" />
                        <span className="font-semibold text-xs">High Returns</span>
                      </div>
                      <div className="text-sm font-bold mb-0">15-20%</div>
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-blue-500 to-indigo-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      <div className="flex items-center gap-1 mb-1">
                        <Battery className="h-3 w-3 group-hover:scale-110 transition-transform duration-300" />
                        <span className="font-semibold text-xs">Quick Payback</span>
                      </div>
                      <div className="text-sm font-bold mb-0">4-6 Yrs</div>
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-purple-500 to-pink-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    <div className="absolute top-0 right-0 w-4 h-4 bg-white/10 rounded-full"></div>
                    <CardContent className="p-2 text-white relative z-10">
                      <div className="flex items-center gap-1 mb-1">
                        <Home className="h-3 w-3 group-hover:scale-110 transition-transform duration-300" />
                        <span className="font-semibold text-xs">Property+</span>
                      </div>
                      <div className="text-sm font-bold mb-0">10-15%</div>
                  ...
                  <Card className="relative overflow-hidden bg-gradient-to-br from-green-500 to-lime-600 border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-1 group">
                    ...
                    <CardContent className="p-2 text-white relative z-10">
                      <div className="flex items-center gap-1 mb-1">
                        <Leaf className="h-3 w-3 group-hover:scale-110 transition-transform duration-300" />
                        <span className="font-semibold text-xs">Eco Impact</span>
                      </div>
                      <div className="text-sm font-bold mb-0">5T+ CO₂</div>
              ...
              <Card className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-xl animate-fade-in hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-blue-500/20 transition-all duration-300" style={{animation: 'floating 40s ease-in-out infinite'}}>
                <CardContent className="p-4">
                  <div className="text-center mb-4">
                    <h3 className="text-base font-bold text-gray-900 dark:text-white mb-1">Analyzing Your Solar Potential</h3>
                        ...
                        <div className={`${index === phaseIndex ? 'animate-pulse' : ''}`}>
                          {index < phaseIndex ? (
                            ...
                            <div className="h-6 w-6 flex items-center justify-center">
                              {React.cloneElement(phase.icon, { className: "h-4 w-4 text-orange-500" })}
                            </div>
                          )}
                        </div>
        ...
        {!loading && result && (
          <div className="space-y-4 animate-fade-in max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {/* Solar Output Card */}
              <Card className="glass backdrop-blur-lg bg-white/50 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:brightness-110 hover:shadow-orange-500/25 group" style={{animation: 'floating 40s ease-in-out infinite'}}>
                <CardHeader className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-t-lg group-hover:from-orange-400 group-hover:to-red-400 transition-all duration-300 pb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-sm">Solar Output & Potential</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-3 bg-white/50 dark:bg-white/5 backdrop-blur rounded-b-lg group-hover:bg-white/60 dark:group-hover:bg-white/10 transition-all duration-300">
                  <div className="space-y-2">
                    <div className="text-center">
                      <div className="text-lg font-bold text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300">{formatNum(result.recommended_kW)} kW</div>
                      <p className="text-xs text-gray-600 dark:text-gray-300">Recommended Load</p>
                    </div>
                    <div className="text-center">
                      <div className="text-sm font-bold text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300">{formatNum(result.solarYield)} kWh/kWp</div>
                      <p className="text-xs text-gray-600 dark:text-gray-300">Solar Potential at Your Area (per year)</p>
                    </div>
                    <div className="text-center">
                      <div className="text-sm font-bold text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300">{formatNum(result.annualEnergy)} kWh</div>
              ...
              <Card className="glass backdrop-blur-lg bg-white/50 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden hover:scale-105 hover:-translate-y-2 hover:brightness-110 hover:shadow-green-500/25 group" style={{animation: 'floating 40s ease-in-out infinite 4s'}}>
                ...
                <CardContent className="p-3 bg-white/50 dark:bg-white/5 backdrop-blur h-full group-hover:bg-white/60 dark:group-hover:bg-white/10 transition-all duration-300">
                  <div className="space-y-1">
              ...
              <Card className="glass backdrop-blur-lg bg-white/50 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden hover:scale-105 hover:-translate-y-2 hover:brightness-110 hover:shadow-teal-500/25 group" style={{animation: 'floating 40s ease-in-out infinite 8s'}}>
                ...
                <CardContent className="p-3 bg-white/50 dark:bg-white/5 backdrop-blur h-full group-hover:bg-white/60 dark:group-hover:bg-white/10 transition-all duration-300">
                  <div className="space-y-3">
                    <div className="text-center">
                      <div className="text-xl font-bold text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300">{formatNum(result.co2Avoided/1000, 1)}</div>
                      <p className="text-xs text-gray-600 dark:text-gray-300">Metric tons CO₂ avoided over 25 years</p>
                    </div>
                    <div className="text-center">
                      <div className="text-xl font-bold text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform duration-300">{result.treesSaved}</div>
            ...
            <div className="text-center mt-4">
              <Button 
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 text-sm"
              >
        ...
        <div className="mt-10 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-orange-500/20" style={{animation: 'floating 40s ease-in-out infinite'}}>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-orange-100/50 dark:bg-orange-900/50 backdrop-blur rounded-lg flex items-center justify-center">
                  <Target className="h-3 w-3 text-orange-600 dark:text-orange-400" />
                </div>
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">India's Solar Initiative</h3>
              </div>
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-green-500/20" style={{animation: 'floating 40s ease-in-out infinite 4s'}}>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-green-100/50 dark:bg-green-900/50 backdrop-blur rounded-lg flex items-center justify-center">
                  <TrendingDown className="h-3 w-3 text-green-600 dark:text-green-400" />
                </div>
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Decreasing Solar Costs</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-red-500/20" style={{animation: 'floating 40s ease-in-out infinite 8s'}}>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-red-100/50 dark:bg-red-900/50 backdrop-blur rounded-lg flex items-center justify-center">
                  <AlertCircle className="h-3 w-3 text-red-600 dark:text-red-400" />
                </div>
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Challenges Homeowners Face</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">
              ...
              <ul className="space-y-1">
                <li className="flex items-start gap-1">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-300">Optimal rooftop solar capacity for their needs</span>
                </li>
                <li className="flex items-start gap-1">
                  <div className="w-1 h-1 bg-red-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-300">Location-specific solar energy generation potential</span>
                </li>
                <li className="flex items-start gap-1">
                  <div className="w-1 h-1 bg-red-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-300">Detailed financial insights including costs and subsidy availability</span>
                </li>
              </ul>
            </div>
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-blue-500/20" style={{animation: 'floating 40s ease-in-out infinite 12s'}}>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-blue-100/50 dark:bg-blue-900/50 backdrop-blur rounded-lg flex items-center justify-center">
                  <Shield className="h-3 w-3 text-blue-600 dark:text-blue-400" />
                </div>
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Sunlytics as the Solution</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">
              ...
              <ul className="space-y-1">
                <li className="flex items-start gap-1">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-300"><strong>Precise location data</strong> to estimate solar energy production accurately</span>
                </li>
                <li className="flex items-start gap-1">
                  <div className="w-1 h-1 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-300"><strong>Optimal system sizing</strong> based on your electricity consumption patterns</span>
                </li>
                <li className="flex items-start gap-1">
                  <div className="w-1 h-1 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <span className="text-xs text-gray-600 dark:text-gray-300"><strong>Detailed financial modeling</strong> including costs, subsidies, payback period, and long-term savings</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8 max-w-3xl mx-auto">
          <h2 className="text-lg font-bold text-center text-gray-900 dark:text-white mb-6">How Our Calculator Works</h2>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-orange-500/20" style={{animation: 'floating 40s ease-in-out infinite'}}>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-orange-100/50 dark:bg-orange-900/50 backdrop-blur rounded-lg flex items-center justify-center">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Solar Data Collection</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300">
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-yellow-500/20" style={{animation: 'floating 40s ease-in-out infinite 4s'}}>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-6 h-6 bg-yellow-100/50 dark:bg-yellow-900/50 backdrop-blur rounded-lg flex items-center justify-center">
                  <Zap className="h-3 w-3 text-yellow-600 dark:text-yellow-400" />
                </div>
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Solar Energy Calculation</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300">
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-green-500/20" style={{animation: 'floating 40s ease-in-out infinite 8s'}}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Financial Modelling</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300">
            ...
            <div className="glass backdrop-blur-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-lg p-3 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:brightness-110 hover:shadow-blue-500/20" style={{animation: 'floating 40s ease-in-out infinite 12s'}}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Personalized Results</h3>
              </div>
              <p className="text-xs text-gray-600 dark:text-gray-300">
